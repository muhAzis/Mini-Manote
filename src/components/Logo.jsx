  ...
  return (
    <div id="logo">
      <svg
        ...
        xmlSpace="preserve"
        version="1.1"
        style={{ fill: 'var(--clr-text-second2)', shapeRendering: 'geometricPrecision', textRendering: 'geometricPrecision', imageRendering: 'optimizeQuality', fillRule: 'evenodd', clipRrule: 'evenodd' }}
      ...
      {windowWidth > 576 && <p className="logo-text">Manote</p>}
    </div>
  );
};
